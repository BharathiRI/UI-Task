      ...
      <Styled.FooterBody>
        ...
        <Styled.FooterCenter>
          <Styled.FooterCenterLeft>
            <Styled.Heading>Get in touch!</Styled.Heading>
            <Styled.Content>
          ...
          <Styled.FooterCenterRight>
            <Styled.ListBox>
              ...
              {servicesArray.map((service: string, index: number) => (
                <Styled.List key={index}>{service}</Styled.List>
              ))}
            </Styled.ListBox>
            <Styled.ListBox>
              <Styled.ListHeading>Resources</Styled.ListHeading>
              {resourcesArray.map((resources: string, index: number) => (
                <Styled.List key={index}>{resources}</Styled.List>
              ))}
            </Styled.ListBox>
            <Styled.ListBox>
