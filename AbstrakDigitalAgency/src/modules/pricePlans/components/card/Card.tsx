...
/**
 * @params We can customize it by using this
 * @returns Each Plans card
 */
  ...
  return (
    <Styled.PricePlansCard>
      <Styled.CardTop>
        ...
        <Styled.PriceBox>
          <Styled.Amount>{monthlyAmount}</Styled.Amount>
          <Styled.AmountPlan>/ {amountPlan}</Styled.AmountPlan>
        </Styled.PriceBox>
        <Button
          type='button'
          size="23px 55px"
